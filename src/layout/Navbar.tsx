  ...
  return (
    <div className="bg-[#04050a] text-white py-6 px-2">
      <div className="container" ref={navbarRef}>
        ...
        />
        <div
          className={`navbar-wrapper max-[1200px]:transition-transform max-[1200px]:duration-300 max-[1200px]:bg-[#222222] max-[1200px]:min-h-screen max-[1200px]:top-0 max-[1200px]:right-0 max-[1200px]:py-20 max-[1200px]:w-[40%] max-[1200px]:fixed max-[1200px]:h-screen max-[1200px]:overflow-y-auto max-[1200px]:z-50 min-[1200px]:block ${
            toggle
              ? "max-[1200px]:translate-x-0"
              : "max-[1200px]:translate-x-full max-[1200px]:hidden"
          }`}
        >
          <div className="flex justify-between items-center max-[1200px]:flex-col max-[1200px]:gap-3 max-[1200px]:px-6">
            <ul className="list-none flex gap-5 mx-0 max-[1200px]:flex max-[1200px]:flex-col">
              <li>
                <Link
                  href="/"
              ...
              <li className="relative">
                ...
                <div
                  className={
                    activeMenu === 1
                      ? `min-[1200px]:absolute min-[1200px]:w-112.5 max-[1200px]:shadow-lg max-[1200px]:rounded-md ring-1 ring-white/5 right-0 mt-8 z-50 bg-[#222222] rounded-xs opacity-100 duration-300 scale-100 origin-top-right`
                      : `min-[1200px]:absolute min-[1200px]:w-112.5 right-0 mt-8 z-50 bg-[#222222] rounded-xs opacity-0 duration-300 scale-0 origin-top-right max-[1200px]:hidden`
                  }
                >
